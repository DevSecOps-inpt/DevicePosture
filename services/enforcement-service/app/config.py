...
ASYNC_DECISION_EXECUTION = os.getenv("ASYNC_DECISION_EXECUTION", "true").lower() == "true"
...
ALLOW_POLICY_HTTP_ACTIONS = os.getenv("ALLOW_POLICY_HTTP_ACTIONS", "false").lower() == "true"
ALLOW_PRIVATE_HTTP_TARGETS = os.getenv("ALLOW_PRIVATE_HTTP_TARGETS", "false").lower() == "true"
